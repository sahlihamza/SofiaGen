const setting = [
  {
    setting: {
      ...
      post_code: "2030",
      contact: "019579034",
      email: "sofiagen@gmail.com",
      website: "sofiagen-admin.vercel.app",
      default_currency: "",
      default_time_zone: "Europe/London",
      default_date_format: "MMM D, YYYY",
      receipt_size: "57-mm",
      from_email: "sale@sofiagen.com",
    ...
    setting: {
      ...
      home: {
        ...
        promotion_title: {
          ...
          de: "100 % natürliches Bio-Qualitétsprodukt",
        },
        ...
        feature_description: {
          ...
          de: "Wählen Sie aus diesen Funktionskategorien die gewénschten Produkte aus.",
        },
        feature_product_limit: 18,
        popular_title: {
          en: "Popular Products for Daily Shopping",
          de: "Beliebte Produkte fér den téglichen Einkauf",
        },
        popular_description: {
          ...
          de: "Sehen Sie sich diese Woche alle unsere beliebten Produkte an. Aus dieser Liste kénnen Sie Produkte fér den téglichen Bedarf auswählen und ein Sonderangebot mit kostenlosem Versand erhalten.",
        },
        ...
        quick_delivery_description: {
          ...
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr téglich benétigtes Produkt aus unserem KachaBazar-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        latest_discount_description: {
          ...
          de: "Sehen Sie sich unten unsere neuesten reduzierten Produkte an. Wählen Sie hier Ihren téglichen Bedarf und erhalten Sie einen Sonderrabatt mit kostenlosem Versand.",
        },
        latest_discount_product_limit: 18,
        daily_need_title: {
          en: "Get Your Daily Needs From Our KachaBazar Store",
          de: "Holen Sie sich Ihren téglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          ...
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr téglich benétigtes Produkt aus unserem KachaBazar-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_description: {
          ...
          de: "Erfassen Sie parallele Metriken und funktionalen ROI ganzheitlich. Revolutionieren Sie nahtlos fehlerfreie interne oder organische Quellen vor effektiven Szenarien. Fördern Sie nach und nach hochmoderne Anwendungen fér effizientes intellektuelles Kapital. Nutzen Sie glaubwürdig vorhandenes unverwechselbares Mindshare durch hochmoderne Schemata. Teambuilding-Paradigmen proaktiv aufschieben koordinieren kundenzentriert total transparent intern. Umfassen Sie dynamisch unterschiedliche Kundendienst- und Installed-Base-Paradigmen. Nutzen Sie glaubwürdig unternehmensweite Erfahrungen fér End-to-End-Daten. Professionelles Branding flexibler Ausrichtungen und kostengénstiger Architekturen. Schaffen Sie enthusiastische Anreize fér nahtlose Gemeinschaften, indem Sie revolutionère Metriken mit strategischen Themenbereichen nahtlos erleichtern.",
        },
        card_one_title: {
          en: "10K",
          de: "10K",
        ...
        middle_description_one: {
          ...
          de: "Erfassen Sie parallele Metriken und funktionalen ROI ganzheitlich. Revolutionieren Sie nahtlos fehlerfreie interne oder organische Quellen vor effektiven Szenarien. Fördern Sie nach und nach hochmoderne Anwendungen fér effizientes intellektuelles Kapital. Nutzen Sie glaubwürdig vorhandenes unverwechselbares Mindshare durch hochmoderne Schemata. Teambuilding-Paradigmen proaktiv aufschieben koordinieren kundenzentriert total transparent intern. Globale Fährung fér qualitativ hochwertige Netzwerke energisch neu konzipieren. Stellen Sie statt genauer Ergebnisse eine gréére Anzahl von Systemen glaubwürdig wieder her. Synergisieren Sie gemeinsam Backend-Bandbreite ohne 24/7-Funktionalitéten. Proaktive Ideen glaubhaft nutzen und crossmediale Kernkompetenzen nutzen. Maximieren Sie auf einzigartige Weise professionelle Best Practices durch ressourcenoptimierende Services. Entwickeln Sie bequem bereichsübergreifende Webservices fér E-Business-Anforderungen.",
        },
        middle_description_two: {
          ...
          de: "Visualisieren Sie marktgesteuerte Daten angemessen vor Eins-zu-eins-Szenarien. Erzielen Sie gemeinsam multifunktionale Renditen durch intuitive Lieferketten. Nutzen Sie mit Begeisterung revolutionère Mehrwert- und prozessorientierte Services. Nutzen Sie intuitive Informationen kompetent nach interoperablen Märkten. Revolutionieren Sie interaktiv zukunftssichere Werte vor granularen Quellen. Umfassen Sie dynamisch unterschiedliche Kundendienst- und Installed-Base-Paradigmen. Nutzen Sie glaubwürdig unternehmensweite Erfahrungen fér End-to-End-Daten. Professionelles Branding flexibler Ausrichtungen und kostengénstiger Architekturen. Schaffen Sie enthusiastische Anreize fér nahtlose Gemeinschaften, indem Sie revolutionère Metriken mit strategischen Themenbereichen nahtlos erleichtern.",
        },
        founder_title: {
          en: "Our Team",
          de: "Unser Grénder",
        ...
        founder_description: {
          ...
          de: "Wir sind unparteiisch und unabhéngig und erstellen jeden Tag unverwechselbare, erstklassige Reintermediate-Backend-Lieferprogramme.",
        },
        founder_one_name: {
          en: "Niamh Shea",
          de: "Niamh Shea ",
      ...
      contact_us: {
        ...
        email_box_email: {
          en: "info@sofiagen.com ",
          de: "info@sofiagen.com",
        },
        email_box_text: {
        ...
        form_title: {
          ...
          de: "För Unterstätzung senden Sie einfach Ihre Anfrage",
        },
        form_description: {
          ...
          de: "Fördern Sie gemeinsam die kundenorientierte Konvergenz gegenéber kundenorientierten Ausrichtungen durch Plagiate strategischer Benutzer und standardisierter Infrastrukturen.",
        },
      },
      offers: {
        header_status: true,
      ...
      faq: {
        ...
        description_one: {
          ...
          de: "Ja. Sie kénnen Ihr Abonnement jederzeit kéndigen. Ihr Abonnement bleibt bis zum Ende Ihrer aktuellen Laufzeit (Monat oder Jahr) aktiv, verléngert sich jedoch nicht automatisch. Sofern Sie Ihr Konto nicht manuell léschen, werden Ihr Konto und alle Daten 60 Tage nach Inaktivitét Ihres Abonnements geléscht.",
        },
        faq_two: {
          en: "Can I cancel my subscription anytime?",
          de: "Kann ich mein Abonnement jederzeit kéndigen?",
        },
        description_two: {
        ...
        description_seven: {
          en: "Yes. You can cancel your subscription anytime. Your subscription will continue to be active until the end of your current term (month or year) but it will not auto-renew. Unless you delete your account manually, your account and all data will be deleted 60 days from the day your subscription becomes inactive.",
          de: "Ja. Sie kénnen Ihr Abonnement jederzeit kéndigen. Ihr Abonnement bleibt bis zum Ende Ihrer aktuellen Laufzeit (Monat oder Jahr) aktiv, verléngert sich jedoch nicht automatisch. Sofern Sie Ihr Konto nicht manuell léschen, werden Ihr Konto und alle Daten 60 Tage nach dem Tag, an dem Ihr Abonnement inaktiv wird, geléscht.",
        },
        faq_eight: {
        ...
        description_eight: {
          en: "Distinctively initiate error-free channels with highly efficient ROI. Intrinsicly envisioneer world-class data via best-of-breed best practices. Efficiently enable empowered e-tailers after cross-unit services. Uniquely expedite seamless e-tailers via cooperative interfaces. Monotonectally myocardinate customer directed meta-services whereas error-free scenarios.",
          de: "Initiieren Sie gezielt fehlerfreie Kanéle mit hocheffizientem ROI. Stellen Sie sich durch branchenführrrennde Best Practices erstklassige Daten vor. Ermöglichen Sie leistungsstarken E-Héndlern auf effiziente Weise die Bereitstellung abteilungsübergreifender Dienstleistungen. Beschleunigen Sie nahtlose E-Tailer auf einzigartige Weise über kooperative Schnittstellen. Monotone myokardinierte kundengesteuerte Metadienste während fehlerfreier Szenarien.",
        },
      },
      slider: {
        ...
        first_title: {
          ...
          de: "Die besten Qualitétsprodukte garantiert!",
        },
        first_description: {
          en: "The Best Quality Products Guaranteed!",
          de: "Die besten Qualitétsprodukte garantiert!",
        ...
        second_description: {
          ...
          de: "Schnelle Béndelung leistungsstarker Netzwerke nach neuen Produkten ...",
        },
        second_button: {
          en: "Shop Now",
          de: "Jetzt einkaufen",
        ...
        third_title: {
          ...
          de: "Qualitétsfrische garantiert!",
        },
        third_description: {
          en: "Intrinsicly fashion performance based products rather than accurate benefits...",
          de: "Gestalten Sie Produkte grundsützlichich auf Leistung und nicht auf konkrete Vorteile ...",
        },
        third_button: {
          en: "Shop Now",
          de: "Jetzt einkaufen",
        ...
        four_description: {
          ...
          de: "Ermöglichen Sie eine effektive Gesamtverknépfung fér weitere Prozesse erheblich.",
        },
        four_button: {
          en: "Shop Now",
          de: "Jetzt einkaufen",
      ...
      slug: {
        ...
        card_description_one: {
          ...
          de: "Kostenloser Versand gilt fér alle Bestellungen über 100 € Versandkosten",
        },
        ...
        card_description_four: {
          ...
          de: "7 Tage Geld-zuréck-Garantie",
        },
      ...
      seo: {
        ...
        meta_url: "https://sofiagen-store-nine.vercel.app/",
      },
    },
